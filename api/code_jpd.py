...
def visualize_dimensionality_reduction_final(input_file, output_dir, user_info):
    try:
        ...
        # Save the combined plots
        combined_png = os.path.join(output_dir, f"visualize_dimensions_final_.png")
        combined_pdf = os.path.join(output_dir, f"visualize_dimensions_final_.pdf")
        plt.savefig(combined_png)
        plt.savefig(combined_pdf)
        plt.close()

        combined_png =  f"{BASE_URL}/files/{user_info['user_id']}/visualize_dimensions_final_.png"
        combined_pdf =  f"{BASE_URL}/files/{user_info['user_id']}/visualize_dimensions_final_.pdf"
